/// @description ??
event_inherited()
if global.debug_ai show_debug_message("Executing move task: ["+string(floor(unit.x/global.grid_cell_width))+","+string(floor(unit.y/global.grid_cell_width))+"]->["+string(floor(target_x/global.grid_cell_width))+","+string(floor(target_y/global.grid_cell_height))+"]")
