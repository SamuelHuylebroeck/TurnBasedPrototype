...
function add_infantry_stats(ds_stat_map)
{
	...
	var flameswordUnitProfile= new UnitProfile("Flamesword", 65,4,15,5)
	...
	var windswordUnitProfile= new UnitProfile("Windsword", 50,5,40,3)
	...
	var groundpounderUnitProfile= new UnitProfile("Groundpounder", 75,3,15,10)
	...
	var waveaxeUnitProfile= new UnitProfile("Wave Axe", 90,4,20,8)
...
function add_heavy_stats(ds_stat_map)
{
	...
	var forgelordUnitProfile= new UnitProfile("Forgelord", 120,3,5,18)
	...
	var tempestknightUnitProfile= new UnitProfile("Tempest Knight", 100,4,15,12)
	...
	var groundsplitterUnitProfile= new UnitProfile("Groundsplitter", 120,2,5,18)
	...
	var captainUnitProfile= new UnitProfile("Captain Knight", 120,4,10,12)
...
function add_archer_stats(ds_stat_map)
{
	...
	var pyroArcherUnitProfile= new UnitProfile("Pyro Archer", 50,3,20,3)
	...
	var boltThrowerUnitProfile= new UnitProfile("Bolt Thrower", 50,4,20,3)
	...
	var shardSlingerUnitProfile= new UnitProfile("Shard Slinger", 60,3,15,5)
	...
	var marineArcherUnitProfile= new UnitProfile("Marine Archer", 65,4,40,5)
