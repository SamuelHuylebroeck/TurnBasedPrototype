...
if global.debug_ai show_debug_message("Executing create weather task on: ["+string(floor(center[0]/global.grid_cell_width))+","+string(floor(center[1]/global.grid_cell_height))+"]")
