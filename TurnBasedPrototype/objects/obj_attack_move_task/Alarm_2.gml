...
if instance_exists(target_unit){
	...
	if global.debug_ai show_debug_message("Executing attack task towards: ["+string(floor(center[0]/global.grid_cell_width))+","+string(floor(center[1]/global.grid_cell_height))+"]")
